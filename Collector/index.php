...
$sql1 = "SELECT * FROM tbl_collector c 
         INNER JOIN tbl_ward w ON c.ward_id=w.ward_id 
         WHERE c.collector_id='$id'";
$result1 = $obj->executequery($sql1);

// Assigned + Accepted requests (with all details)
$sql2 = "SELECT c.customer_id, c.customer_name, r.request_id,
...
// Collect requests in array
$collectors = [];
while ($row = mysqli_fetch_assoc($result2)) {
    $collectors[] = $row;
}

// Distinct customers from collectors
$uniqueCustomers = [];
foreach ($collectors as $collector) {
    $uniqueCustomers[$collector['customer_id']] = $collector;
    // ensures each customer appears once
}
...
<div class="slides">
    ...
    <!-- Slide 2: Show distinct customers -->
                        ...
                        if (!in_array($collector["customer_id"], $shown)) {
                            ...
                            <div class="stylish-box text-center fs-5 fw-bold"
                                ...
                                <div>
                                    ...
                                    <em
                                        style=" font-size: 1.5rem; font-weight: 700;"><?php echo $collector["customer_name"]; ?></em>
                                    </a>
                    ...
                    if ($collector['status'] == 'Accepted') {
                        ...
                        <div class="stylish-box text-lg">
                            <div class="light-grey-box p-3">
                                <div><b>Customer Name: <?php echo $collector["customer_name"]; ?></b></div><br>

      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            <li class="nav-small-cap">
              ...
              <a class="sidebar-link justify-content-between has-arrow" href="javascript:void(0)" aria-expanded="false">
                <div class="d-flex align-items-center gap-3">
                  ...
                  <span class="hide-menu">Registerations</span>
                </div>
              ...
              <ul aria-expanded="false" class="collapse first-level">
                <li class="sidebar-item">
                  <a class="sidebar-link justify-content-between"  
                    href="ward_registeration.php">
                    <div class="d-flex align-items-center gap-3">
                      <div class="round-16 d-flex align-items-center justify-content-center">
                        <i class="ti ti-circle"></i>
                      </div>
                      <span class="hide-menu">Muncipal Wards</span>
                    </div>
                ...
                <li class="sidebar-item">
                  <a class="sidebar-link justify-content-between"  
                    href="itemcollector.php">
                    <div class="d-flex align-items-center gap-3">
                      <div class="round-16 d-flex align-items-center justify-content-center">
                        <i class="ti ti-circle"></i>
                      </div>
                      <span class="hide-menu">Item Collectors</span>
                    </div>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link justify-content-between"  
                href="itemcollector_view.php" aria-expanded="false">
                <div class="d-flex align-items-center gap-3">
                  <span class="d-flex">
                    <i class="ti ti-aperture"></i>
                  </span>
                  <span class="hide-menu">Item Collector view</span>
                </div>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link justify-content-between"  
                href="orderview.php" aria-expanded="false">
                <div class="d-flex align-items-center gap-3">
                  <span class="d-flex">
                    <i class="ti ti-shopping-cart"></i>
                  </span>
                  <span class="hide-menu">Orderview</span>
                </div>
            ...
            <li class="sidebar-item">
  <a class="sidebar-link justify-content-between"  
    href="paymentview.php" aria-expanded="false">
    <div class="d-flex align-items-center gap-3">
      <span class="d-flex">
        <i class="ti ti-credit-card"></i>
      </span>
      <span class="hide-menu">Paymentview</span>
    </div>
  </a>
</li>
            <li class="sidebar-item">

            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-2 py-lg-0" >
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse" >
                    ...
                    <div class="navbar-nav ms-auto">
                        ...
                        <a href="login.php" class="nav-item nav-link">Login/Signup<span>👤</span></a>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-4">
                            <img class="img-fluid bg-white w-100" src="index/img/a4.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container py-5">
            ...
            <div class="owl-carousel product-carousel wow fadeInUp" data-wow-delay="0.5s">
                <a href="" class="d-block product-item rounded">
                    <img src="index/img/product-1.jpg" alt="">
                ...
                <a href="" class="d-block product-item rounded">
                    <img src="index/img/product-2.jpg" alt="">
                    <div class="bg-white shadow-sm text-center p-4 position-relative mt-n5 mx-4">
                ...
                <a href="" class="d-block product-item rounded">
                    <img src="index/img/product-3.jpg" alt="">
                    <div class="bg-white shadow-sm text-center p-4 position-relative mt-n5 mx-4">
                ...
                <a href="" class="d-block product-item rounded">
                    <img src="index/img/product-4.jpg" alt="">
                    <div class="bg-white shadow-sm text-center p-4 position-relative mt-n5 mx-4">
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="store-item position-relative text-center">
                        <img class="img-fluid" src="index/img/store-product-1.jpg" alt="">
                        <div class="p-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="store-item position-relative text-center">
                        <img class="img-fluid" src="index/img/store-product-2.jpg" alt="">
                        <div class="p-4">
                            <div class="text-center mb-3">
                                <small class="fa fa-star text-primary"></small>
                                <small class="fa fa-star text-primary"></small>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="store-item position-relative text-center">
                        <img class="img-fluid" src="index/img/store-product-3.jpg" alt="">
                        <div class="p-4">
                            <div class="text-center mb-3">
                                <small class="fa fa-star text-primary"></small>
                                <small class="fa fa-star text-primary"></small>

        ...
        <?php while ($display = mysqli_fetch_array($result)) { ?>
          <div class="col-lg-3 col-md-4 col-sm-6">
            <div class="store-item position-relative text-center">
              <img style="height:300px;width:400px;border-radius:20px" class="img-fluid "
                src="../uploads/<?php echo $display['product_image']; ?>" alt="image">
              <div class="p-4">
                ...
                <h4 class="mb-3"><?php echo $display['product_name']; ?></h4>
                <p><?php echo $display['product_description']; ?></p>
                <h4 class="text-primary">Rs.<?php echo $display['product_price']; ?>/-</h4>
                <div class="coin-balance">
                <i class="fa-solid fa-bolt"><?php echo $display['product_coin']; ?>Coins</i>
                </div>
                <h4 class="text-secondary"><?php echo $display['product_stock']; ?> Stock Left!</h4>

              </div>
              <div class="store-overlay">
                <a href="payment.php" class="btn btn-primary rounded-pill py-2 px-4 m-2">Buy Now <i
                    class="fa fa-arrow-right ms-2"></i></a>
                <a href="addtocart.php?product_id=<?php echo $display["product_id"]; ?>"
                  class="btn btn-dark rounded-pill py-2 px-4 m-2">Add to Cart <i class="fa fa-cart-plus ms-2"></i></a>
              </div>
            </div>
          </div>
        <?php } ?>
